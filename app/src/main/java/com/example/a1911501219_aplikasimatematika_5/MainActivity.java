...
public class MainActivity extends AppCompatActivity {
    ...
    public void jajargenjang(View view){
        ...
        jajargenjangalert.setMessage("Apakah anda yakin ingin menghitung luas segitiga siku siku");
    ...
    public void onBackPressed(){
        ...
        tombolkeluar.setIcon(R.drawable.pensil);
        ...
        tombolkeluar.setNegativeButton("No", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
            }
        });
        tombolkeluar.setNeutralButton("Cancel", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                dialog.cancel();
            }
